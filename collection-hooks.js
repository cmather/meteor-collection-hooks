if (!Meteor.Collection)
  throw new Error('Meteor.Collection is not defined');
...
Meteor.Collection.pauseHooks = function () {
  Meteor.Collection._isHooksPaused = true;
};

Meteor.Collection.resumeHooks = function () {
  Meteor.Collection._isHooksPaused = false;
};
...
var runHooks = function (klass, hook, collection, args) {
  ...
  if (Meteor.Collection._isHooksPaused === true)
    return;
